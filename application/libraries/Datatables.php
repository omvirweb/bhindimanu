...
class Datatables
{
    ...
    private function _get_datatables_query()
    {
        ...
        if(!empty($this->where_not_in)){
            $this->ci->db->where_not_in($this->where_not_in['column_name'],$this->where_not_in['array']);
        }
        
        if(!empty($this->where_in)){
            $this->ci->db->where_in($this->where_in['column_name'],$this->where_in['array']);
        }
     ...
     * @return mixed
     */
    public function count_all($id_column = '')
    {
        if(!empty($id_column)) {
            $this->ci->db->select($id_column);
        }
