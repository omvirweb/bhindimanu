                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <a class="toggle-vis text-info" data-column="11">Issue Gross</a> &nbsp;-&nbsp;
                                    <a class="toggle-vis text-info" data-column="12">Issue Moti Wt.</a> &nbsp;-&nbsp;
                                    <a class="toggle-vis text-info" data-column="13">Issue Stone Wt.</a> &nbsp;-&nbsp;
                                    <a class="toggle-vis text-info" data-column="14">Issue Stone Pcs</a> &nbsp;-&nbsp;
                                    <a class="toggle-vis text-info" data-column="15">Issue Fine</a> &nbsp;-&nbsp;
                                    <a class="toggle-vis text-info" data-column="16">Issue Amount</a>
                            </div>
                            <div class="col-md-12">
                                <table id="person_ledger_report" class="table table-bordered table-striped" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th></th>
                                            <th colspan="9">Receive / Jama</th>
                                            <th colspan="6">Issue / Udhar</th>
                                        </tr>
                                        <tr>
                                            <th>Date</th>
                                            <th>Particular</th>
...
<script type="text/javascript">
    var person_ledger_report;
    $(document).ready(function(){
        initAjaxSelect2($("#job_worker_id"), "<?= base_url('app/job_worker_select2_source') ?>");

        person_ledger_report = $('#person_ledger_report').DataTable({
            "serverSide": true,
            "ordering": false,
            "scrollY": '480px',
            "scrollX": true,
            ...
            "ajax": {
                "url": "<?php echo site_url('report/person_ledger_datatable') ?>",
                "type": "POST",
                "data": function (d) {
        ...
        $('a.toggle-vis').on( 'click', function (e) {
            ...
            var column = person_ledger_report.column( $(this).attr('data-column') );
            // Toggle the visibility
            column.visible( ! column.visible() );
        } );

        $(document).on('click','#btn_search',function(){
            person_ledger_report.draw();
        });
    });
</script>
<?php
